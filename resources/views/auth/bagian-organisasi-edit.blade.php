...
<div class="container mt-5" style="max-width:700px">
    ...
    <div class="card border-0 shadow-sm rounded-4 p-4">
        ...
        <form action="{{ route('admin.bagian-organisasi.update', $jenis) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                @if(!empty($data->file_pdf))
                    <small class="text-muted mt-1 d-block">File saat ini: 
                        <a href="{{ asset($data->file_pdf) }}" target="_blank">Lihat PDF</a>
                    </small>
                @endif
            </div>
