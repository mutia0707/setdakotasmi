...
<nav class="navbar navbar-dark navbar-admin py-3">
    <div class="container">
        <span class="navbar-brand fw-bold"><i class="bi bi-bar-chart-fill me-2"></i> KELOLA PELAPORAN</span>
...
<div class="container mt-5">
    ...
    <div class="row g-4 justify-content-center">
        @foreach([['lkip','LKIP','file-earmark-bar-graph'],['lppd','LPPD','file-earmark-text'],['spm','SPM','clipboard-check']] as $item)
        <div class="col-md-3">
            <div class="card card-menu p-4 text-center">
                <div class="icon-circle"><i class="bi bi-{{ $item[2] }}"></i></div>
                <h5 class="fw-bold mb-3">{{ $item[1] }}</h5>
                <a href="{{ route('admin.pelaporan.edit', $item[0]) }}" class="btn btn-primary fw-bold w-100">Kelola</a>
            </div>
        </div>
        @endforeach
    </div>
