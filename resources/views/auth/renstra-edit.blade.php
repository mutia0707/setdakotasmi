...
<div class="p-3 mb-4 text-white" style="background-color: #343a40;">
    <div class="container d-flex justify-content-between align-items-center">
        <h5 class="fw-bold m-0"><i class="bi bi-file-earmark-pdf me-2"></i> KELOLA RENSTRA</h5>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="admin-card">
                ...
                <form action="{{ route('admin.renstra.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="mb-3">
                        <label class="form-label">Deskripsi (Judul/Renstra)</label>
                        <textarea name="deskripsi" class="form-control" rows="6" required>{{ $data->deskripsi ?? '' }}</textarea>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Tujuan Strategis</label>
