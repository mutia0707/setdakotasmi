...
<head>
    <meta charset="UTF-8">
    <title>Kelola Pelayanan dan Hukum</title>
...
<nav class="navbar navbar-dark navbar-admin py-3">
    <div class="container">
        <span class="navbar-brand fw-bold"><i class="bi bi-shield-check me-2"></i> KELOLA PELAYANAN DAN HUKUM</span>
...
<div class="container mt-5">
    ...
    <div class="row g-4 justify-content-center">
        @foreach([
            ['pelayanan_publik', 'Pelayanan Publik', 'people-fill'],
            ['bantuan_hukum', 'Bantuan Hukum', 'journal-bookmark-fill']
        ] as $item)
        <div class="col-md-3">
            <div class="card card-menu p-4 text-center">
                <div class="icon-circle"><i class="bi bi-{{ $item[2] }}"></i></div>
                <h5 class="fw-bold mb-3">{{ $item[1] }}</h5>
                <a href="{{ route('admin.pelayanan-hukum.edit', $item[0]) }}" class="btn btn-primary fw-bold w-100">Kelola</a>
            </div>
        </div>
        @endforeach
    </div>
