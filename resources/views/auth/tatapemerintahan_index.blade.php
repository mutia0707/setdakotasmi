...
<head>
    <meta charset="UTF-8">
    <title>Kelola Tata Pemerintahan</title>
...
<nav class="navbar navbar-dark navbar-admin py-3">
    <div class="container">
        <span class="navbar-brand fw-bold"><i class="bi bi-bank me-2"></i> KELOLA TATA PEMERINTAHAN</span>
...
<div class="container mt-5">
    ...
    <div class="row g-4 justify-content-center">
        @foreach([
            ['kunjungan-pimpinan', 'Kunjungan Pimpinan', 'people-fill'],
            ['fasilitasi-pemilu', 'Fasilitasi Pemilu & Pilkada', 'check2-square']
        ] as $item)
        <div class="col-md-3">
            <div class="card card-menu p-4 text-center">
                <div class="icon-circle"><i class="bi bi-{{ $item[2] }}"></i></div>
                <h5 class="fw-bold mb-3">{{ $item[1] }}</h5>
                <a href="{{ route('admin.tatapemerintahan.edit', $item[0]) }}" class="btn btn-primary fw-bold w-100">Kelola</a>
            </div>
        </div>
        @endforeach 
    </div>
