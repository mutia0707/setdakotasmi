...
<nav class="navbar navbar-dark navbar-admin py-3">
    <div class="container">
        <span class="navbar-brand fw-bold"><i class="bi bi-envelope-paper me-2"></i> Kelola Alur Surat</span>
...
<div class="container mt-5" style="max-width:600px">
    ...
    <div class="card border-0 shadow-sm rounded-4 p-4">
        <h6 class="fw-bold mb-1">Upload SOP Alur Surat (PDF)</h6>
        ...
        <form action="{{ route('admin.alursurat.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
