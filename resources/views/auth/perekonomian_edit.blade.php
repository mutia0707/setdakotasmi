...
<head>
    <meta charset="UTF-8">
    <title>Kelola {{ strtoupper($slug) }}</title>
...
<nav class="navbar navbar-dark navbar-admin py-3">
    <div class="container">
        <span class="navbar-brand fw-bold"><i class="bi bi-building me-2"></i> Kelola {{ strtoupper($slug) }}</span>
...
<div class="container mt-5" style="max-width:700px">
    ...
    <div class="card border-0 shadow-sm rounded-4 p-4">
        <h6 class="fw-bold mb-3">Edit Konten {{ strtoupper($slug) }}</h6>
