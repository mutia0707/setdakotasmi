        ...
        <div class="row g-3 mb-4">
            <div class="col-md-4">
                <div class="card p-3 shadow-sm">
                    <h6 class="fw-bold"><i class="bi bi-image text-primary"></i> Foto Sambutan</h6>
            ...
            <div class="col-md-4">
                <div class="card p-3 shadow-sm">
                    <h6 class="fw-bold"><i class="bi bi-newspaper text-success"></i> Foto Berita Utama</h6>
            ...
            <div class="col-md-4">
                <div class="card p-3 shadow-sm">
                    <h6 class="fw-bold"><i class="bi bi-person-badge text-warning"></i> Foto Pejabat</h6>
