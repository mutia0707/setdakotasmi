...
<div class="container mt-5">
    ...
    {{-- Form Upload Cepat untuk Admin/Staff yang sedang Login --}}
    @auth
            ...
            <div class="col-md-4 mb-5">
                <div class="card h-100">
                    <div class="card-img-container">
                        @if($item->gambar)
                            {{-- Menggunakan asset storage publik sesuai fungsi controller store --}}
                    ...
                    <div class="card-body d-flex flex-column">
                        <span class="category-tag">
                            <i class="bi bi-building me-1"></i> {{ $item->bagian ?? 'Admin Kota' }}
                        </span>
                        ...
                        <div class="mt-auto pt-3 border-top d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('berita.show', $item->slug) }}" class="btn btn-read-more btn-sm">SELENGKAPNYA</a>
                        </div>
                    </div>
                </div>
            </div>
