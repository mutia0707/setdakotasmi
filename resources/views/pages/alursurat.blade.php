...
<div class="page-header">
    <div class="container d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h2 class="fw-bold m-0 text-white">ALUR PELAYANAN</h2>
...
<div class="container">
    <div class="main-content text-center">
        <h4 class="fw-bold text-primary mb-4 border-bottom pb-2">Dokumen SOP Pelayanan</h4>
        
        @if(isset($data) && $data && $data->file_pdf)
            <p class="mb-4 text-muted">Klik tombol di bawah untuk mengunduh dokumen SOP Alur Pelayanan Surat secara resmi.</p>
            <a href="{{ asset($data->file_pdf) }}" target="_blank" class="btn btn-primary btn-sop">
                <i class="bi bi-file-pdf me-2"></i> Download SOP Alur Surat (PDF)
            </a>
        @else
            <div class="py-5">
