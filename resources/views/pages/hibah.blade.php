...
<head>
    ...
    <title>Penerima Hibah - SETDA Kota Sukabumi</title>
...
<div class="page-header">
    <div class="container d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h3 class="fw-bold m-0 text-white">PENERIMA HIBAH</h3>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="main-content">
                <h5 class="fw-bold text-primary mb-4 border-bottom pb-2">Daftar Dokumen Penerima Hibah</h5>
                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        {{-- Menggunakan variabel $hibah yang dikirim dari controller --}}
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ asset('storage/' . $h->file_path) }}" class="btn btn-primary btn-sm rounded-pill px-3" download>
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="text-center text-muted py-4">Belum ada dokumen hibah yang tersedia.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
