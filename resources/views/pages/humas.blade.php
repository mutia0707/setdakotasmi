...
<head>
    ...
    <title>Bagian Humas - SETDA Kota Sukabumi</title>
...
<div class="page-header">
    <div class="container d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h2 class="fw-bold m-0 text-white">BAGIAN HUMAS</h2>
...
<div class="container">
    <div class="main-content">
        <div class="text-center mb-5">
            <span class="badge-jenis"><i class="bi bi-megaphone-fill me-1"></i> Humas</span>
            <h2 class="header-title">Dokumen & Dokumentasi</h2>
